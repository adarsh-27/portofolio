  ...
  return (
    <div id='home' className='pb-20 pt-36'>
        <div>
            ...
            fill="white"
            />
            <Spotlight className="top-10 left-full h-[80vh]" fill="pink" />
            <Spotlight
        ...
        <div className="h-screen w-full dark:bg-black-100 bg-black  dark:bg-grid-white/[0.1] bg-grid-black/[0.2] flex items-center justify-center absolute top-0 left-0">
        ...
        <div className='flex text-white justify-center relative my-20 -z-10'>
